...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_2.addWidget(self.spin_list, 5, 0, 1, 2)
        self.initialize_spins = QtWidgets.QPushButton(self.tab_6)
        self.initialize_spins.setObjectName("initialize_spins")
        self.gridLayout_2.addWidget(self.initialize_spins, 3, 0, 1, 2)
        ...
        self.gridLayout_4.addWidget(self.tabWidget_5, 1, 0, 1, 1)
        self.exchange_image = QtWidgets.QLabel(self.tab_5)
        self.exchange_image.setText("")
        self.exchange_image.setObjectName("exchange_image")
        self.gridLayout_4.addWidget(self.exchange_image, 0, 0, 1, 1)
        ...
        self.field_image = QtWidgets.QLabel(self.tab_9)
        self.field_image.setText("")
        self.field_image.setObjectName("field_image")
        self.gridLayout_25.addWidget(self.field_image, 0, 0, 1, 1)
        self.tabWidget.addTab(self.tab_9, "")
        self.tab_18 = QtWidgets.QWidget()
        self.tab_18.setObjectName("tab_18")
        self.gridLayout_34 = QtWidgets.QGridLayout(self.tab_18)
        self.gridLayout_34.setObjectName("gridLayout_34")
        self.label_39 = QtWidgets.QLabel(self.tab_18)
        self.label_39.setObjectName("label_39")
        self.gridLayout_34.addWidget(self.label_39, 0, 0, 1, 1)
        self.xyz_box = QtWidgets.QTextEdit(self.tab_18)
        self.xyz_box.setEnabled(False)
        self.xyz_box.setObjectName("xyz_box")
        self.gridLayout_34.addWidget(self.xyz_box, 1, 0, 1, 1)
        ...
        self.parallelization = QtWidgets.QComboBox(self.tab_10)
        self.parallelization.setObjectName("parallelization")
        self.parallelization.addItem("")
        self.parallelization.addItem("")
        self.gridLayout_11.addWidget(self.parallelization, 2, 1, 1, 1)
        self.label_37 = QtWidgets.QLabel(self.tab_10)
        self.label_37.setObjectName("label_37")
        self.gridLayout_11.addWidget(self.label_37, 3, 0, 1, 1)
        self.preferred_mode = QtWidgets.QComboBox(self.tab_10)
        self.preferred_mode.setObjectName("preferred_mode")
        self.preferred_mode.addItem("")
        self.preferred_mode.addItem("")
        self.gridLayout_11.addWidget(self.preferred_mode, 3, 1, 1, 1)
        ...
        self.gridLayout_21.addWidget(self.get_magnetization, 1, 0, 1, 2)
        self.magnetization_image = QtWidgets.QLabel(self.tab_2)
        self.magnetization_image.setText("")
        self.magnetization_image.setObjectName("magnetization_image")
        self.gridLayout_21.addWidget(self.magnetization_image, 2, 0, 1, 2)
        ...
        self.gridLayout_10.addWidget(self.get_static_correlator, 2, 0, 1, 2)
        ...
        self.gridLayout_13.addWidget(self.get_dynamical_correlator_map, 2, 0, 1, 2)
        self.gridLayout_16.addLayout(self.gridLayout_13, 0, 0, 1, 1)
        self.dynamical_image = QtWidgets.QLabel(self.tab_12)
        self.dynamical_image.setText("")
        self.dynamical_image.setObjectName("dynamical_image")
        self.gridLayout_16.addWidget(self.dynamical_image, 1, 0, 1, 1)
        ...
        self.gridLayout_33 = QtWidgets.QGridLayout(self.tab_17)
        self.gridLayout_33.setObjectName("gridLayout_33")
        self.gridLayout_32 = QtWidgets.QGridLayout()
        self.gridLayout_32.setObjectName("gridLayout_32")
        self.num_excited = QtWidgets.QLineEdit(self.tab_17)
        self.num_excited.setObjectName("num_excited")
        self.gridLayout_32.addWidget(self.num_excited, 0, 1, 1, 1)
        self.label_35 = QtWidgets.QLabel(self.tab_17)
        self.label_35.setObjectName("label_35")
        self.gridLayout_32.addWidget(self.label_35, 0, 0, 1, 1)
        self.get_excited_states = QtWidgets.QPushButton(self.tab_17)
        self.get_excited_states.setObjectName("get_excited_states")
        self.gridLayout_32.addWidget(self.get_excited_states, 2, 0, 1, 2)
        self.substract_gs_excited = QtWidgets.QComboBox(self.tab_17)
        self.substract_gs_excited.setObjectName("substract_gs_excited")
        self.substract_gs_excited.addItem("")
        self.substract_gs_excited.addItem("")
        self.gridLayout_32.addWidget(self.substract_gs_excited, 1, 1, 1, 1)
        self.label_36 = QtWidgets.QLabel(self.tab_17)
        self.label_36.setObjectName("label_36")
        self.gridLayout_32.addWidget(self.label_36, 1, 0, 1, 1)
        ...
        self.data_box = QtWidgets.QTextEdit(self.tab_15)
        self.data_box.setObjectName("data_box")
        self.gridLayout_5.addWidget(self.data_box, 0, 0, 1, 1)
        ...
        self.maxm_min = QtWidgets.QLineEdit(self.tab_16)
        self.maxm_min.setObjectName("maxm_min")
        self.gridLayout_30.addWidget(self.maxm_min, 0, 1, 1, 1)
        self.maxm_max = QtWidgets.QLineEdit(self.tab_16)
        self.maxm_max.setObjectName("maxm_max")
        self.gridLayout_30.addWidget(self.maxm_max, 1, 1, 1, 1)
        self.maxm_step = QtWidgets.QLineEdit(self.tab_16)
        self.maxm_step.setObjectName("maxm_step")
        self.gridLayout_30.addWidget(self.maxm_step, 2, 1, 1, 1)
        ...
        self.get_gs_convergence = QtWidgets.QPushButton(self.tab_16)
        self.get_gs_convergence.setObjectName("get_gs_convergence")
        self.gridLayout_30.addWidget(self.get_gs_convergence, 3, 0, 1, 2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_38.setText(_translate("MainWindow", "Default spin site"))
        self.label.setText(_translate("MainWindow", "Number of spin sites"))
        self.nsites.setToolTip(_translate("MainWindow", "Number of sites of the spin chain"))
        self.nsites.setText(_translate("MainWindow", "6"))
        self.spin_combination.setToolTip(_translate("MainWindow", "Select the default kind of spin chain that will be created"))
        self.spin_combination.setItemText(0, _translate("MainWindow", "1/2"))
        self.spin_combination.setItemText(1, _translate("MainWindow", "1"))
        self.spin_combination.setItemText(2, _translate("MainWindow", "1/2 & 1"))
        self.spin_combination.setItemText(3, _translate("MainWindow", "3/2"))
        self.spin_combination.setItemText(4, _translate("MainWindow", "1 & 3/2"))
        self.spin_combination.setItemText(5, _translate("MainWindow", "2"))
        self.spin_combination.setItemText(6, _translate("MainWindow", "5/2"))
        self.label_5.setText(_translate("MainWindow", "Table with the spins"))
        self.initialize_spins.setToolTip(_translate("MainWindow", "Initialize all the spins and all the terms in the Hamiltonian"))
        self.initialize_spins.setText(_translate("MainWindow", "Full spin initialization"))
        ...
        self.tabWidget_5.setTabText(self.tabWidget_5.indexOf(self.tab), _translate("MainWindow", "Exchange table"))
        ...
        self.tabWidget_5.setTabText(self.tabWidget_5.indexOf(self.tab_14), _translate("MainWindow", "Generator"))
        ...
        self.label_39.setText(_translate("MainWindow", "x y z"))
        self.xyz_box.setToolTip(_translate("MainWindow", "Latest data that has been computed"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_18), _translate("MainWindow", "Positions"))
        ...
        self.maxm.setText(_translate("MainWindow", "15"))
        self.nsweeps.setToolTip(_translate("MainWindow", "Number of sweeps of the DMRG algorithm, increase for higher accuracy"))
        self.nsweeps.setText(_translate("MainWindow", "6"))
        self.label_10.setText(_translate("MainWindow", "Bond dimension"))
        self.label_11.setText(_translate("MainWindow", "Number of sweeps"))
        self.label_31.setText(_translate("MainWindow", "Parallelization"))
        self.parallelization.setToolTip(_translate("MainWindow", "Parallelize the calculation of certain parts, using all the available cores"))
        self.parallelization.setItemText(0, _translate("MainWindow", "No"))
        self.parallelization.setItemText(1, _translate("MainWindow", "Yes"))
        self.label_37.setText(_translate("MainWindow", "Preferred mode"))
        self.preferred_mode.setToolTip(_translate("MainWindow", "Select whether if the program should try to use the ED mode if possible (so far only implemented for excited states and magnetization)"))
        self.preferred_mode.setItemText(0, _translate("MainWindow", "DMRG"))
        self.preferred_mode.setItemText(1, _translate("MainWindow", "ED"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_10), _translate("MainWindow", "Parameters"))
        ...
        self.get_magnetization.setText(_translate("MainWindow", "Show magnetization"))
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab_2), _translate("MainWindow", "Magnetization"))
        ...
        self.get_static_correlator.setText(_translate("MainWindow", "Show static correlator"))
        ...
        self.num_excited.setToolTip(_translate("MainWindow", "Number of excited states to compute"))
        self.num_excited.setText(_translate("MainWindow", "4"))
        self.label_35.setText(_translate("MainWindow", "Number of excited states"))
        self.get_excited_states.setToolTip(_translate("MainWindow", "Compute and show the excited states"))
        self.get_excited_states.setText(_translate("MainWindow", "Show excited states"))
        self.substract_gs_excited.setToolTip(_translate("MainWindow", "Choose whether if the ground state energy should be substracted from the energies of the excited states"))
        self.substract_gs_excited.setItemText(0, _translate("MainWindow", "No"))
        self.substract_gs_excited.setItemText(1, _translate("MainWindow", "Yes"))
        self.label_36.setText(_translate("MainWindow", "Substract GS energy"))
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab_17), _translate("MainWindow", "Excitated states"))
        self.data_box.setToolTip(_translate("MainWindow", "Latest data that has been computed"))
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab_15), _translate("MainWindow", "Data"))
        self.maxm_min.setText(_translate("MainWindow", "5"))
        self.maxm_max.setText(_translate("MainWindow", "30"))
        self.maxm_step.setText(_translate("MainWindow", "5"))
        self.label_32.setText(_translate("MainWindow", "Minimum bond dimension"))
        self.label_33.setText(_translate("MainWindow", "Maximum bond dimension"))
        self.label_34.setText(_translate("MainWindow", "Step"))
        self.get_gs_convergence.setText(_translate("MainWindow", "Show ground state energy convergence"))
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab_16), _translate("MainWindow", "Convergence"))
